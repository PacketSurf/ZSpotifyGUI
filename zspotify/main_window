...
"}")
        ...
        self.playingInfo1.setAlignment(QtCore.Qt.AlignCenter)
        self.playingInfo1.setObjectName("playingInfo1")
        self.horizontalLayout_7.addWidget(self.playingInfo1)
        self.playingInfo2 = QtWidgets.QLabel(self.mediaControls)
        self.playingInfo2.setText("")
        self.playingInfo2.setAlignment(QtCore.Qt.AlignCenter)
        self.playingInfo2.setObjectName("playingInfo2")
        self.horizontalLayout_7.addWidget(self.playingInfo2)
