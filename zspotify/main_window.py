...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.resultAmountCombo.sizePolicy().hasHeightForWidth())
        self.resultAmountCombo.setSizePolicy(sizePolicy)
        self.resultAmountCombo.setMinimumSize(QtCore.QSize(64, 0))
        self.resultAmountCombo.setMaximumSize(QtCore.QSize(64, 16777215))
        self.resultAmountCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.resultAmountCombo.setMinimumContentsLength(7)
        self.resultAmountCombo.setDuplicatesEnabled(False)
        ...
        self.resultAmountCombo.setCurrentIndex(0)
